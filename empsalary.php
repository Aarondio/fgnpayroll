                        ...
                        <div class="row">
                            <div class="col-sm-6 m-b-20">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li>Centeral Bank of Nigeria</li>
                                    <li>Plot 33, Abubakar Tafawa Balewa Way</li>
                                    <li>Central Business District</li>
                                    <li>P.M.B. 0187,Garki Abuja.</li>
                                </ul>
                            </div>
                            <div class="col-sm-6 m-b-20">
                        ...
                        <div class="row">
                            <div class="col-lg-12 m-b-20">
                                <ul class="list-unstyled">
                                    ...
                                    <li>Employee ID: <?php echo $_SESSION['EmpID']?></li>
                                    <li>Joined Service On:<?php echo $object->get_employee_join_date($_SESSION['ID'])?>
                                    </li>
                                </ul>
                            </div>
                        </div>
