                                ...
                                <?php 
                                  ...
                                  while($row = mysqli_fetch_array($result)){?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href="salary-view.php?id=<?php echo $row['empID'] ?>">Generate Slip</a></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit_salary.php?id=<?php echo $row['id'] ?>" data-toggle="modal" data-target="#edit_salary<?php echo $row['id'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="task/delete_salary.php?id=<?php echo $row['id'] ?>" data-toggle="modal" data-target="#delete_salary<?php echo $row['id'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                           <!-- Edit Salary Modal -->
